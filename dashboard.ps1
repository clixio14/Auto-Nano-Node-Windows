...
function Show-Dashboard {
    ...
    try {
        ...
        $networkWatts   = ($downMbps + $upMbps) / 100 * 0.5
    ...
    Write-Host "] Stop   [" -NoNewline; Write-Host "S" -ForegroundColor Red -NoNewline
    Write-Host "] Start   [" -NoNewline; Write-Host "R" -ForegroundColor Red -NoNewline
    Write-Host "] Restart   [" -NoNewline; Write-Host "CTRL+C" -ForegroundColor Red -NoNewline
    Write-Host "] Exit"
