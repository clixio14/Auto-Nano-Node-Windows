...
if ($odometerTaskExists) {
    ...
    $snapshotUrl = (Invoke-WebRequest -Uri "https://s3.us-east-2.amazonaws.com/repo.nano.org/snapshots/latest" -UseBasicParsing).Content.Trim()
...
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  ✓ Nano Node is running as a background service" -ForegroundColor White
Write-Host "  ✓ Ledger snapshot loaded  (you saved 90+ hours of sync time)" -ForegroundColor White
Write-Host "  ✓ Odometer is active and counting uptime every minute" -ForegroundColor White
Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
